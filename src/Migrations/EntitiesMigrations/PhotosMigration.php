...
class PhotosMigration implements IMigration
{
    public function getQueryCreation(): string
    {
        return 'CREATE TABLE photos (
            ...
            photo_id INTEGER
        ); ALTER TABLE photos_politicians ADD CONSTRAINT `politician_id_photos_politicians_politicians` FOREIGN KEY (`politician_id`) REFERENCES `politicians` (`id`);
        ALTER TABLE photos_politicians ADD CONSTRAINT `photo_id_photos_politicians_politicians` FOREIGN KEY (`photo_id`) REFERENCES `photos` (`id`);';
    }
}
